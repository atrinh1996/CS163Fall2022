...
class LineSegmentIntersection():
    ...
    def handleEventPoint(self, eventNode):
        ...
        for seg in statusList2:
            ...
            lower = upper
        # if (len(LC) == 0):
        #     # l and u are the lower and upper neighbors to p in status tree
        #     # self.findNewEvent(None, None, p)
        #     lower = None 
        #     upper = None 
        #     for seg in statusList2:
        #         upper = seg 
        ...
        #         lower = upper
        # else: 
        #     # s' is the lowermost segment of LC in status 
        #     # sl is the lower neighbor of sl in status 
        #     self.findNewEvent(lower, lowermost, p)

        #     # s'' is the uppermost segment of LC in status 
        #     # sr is the upper neighbor of su in status 
        #     self.findNewEvent(uppermost, upper, p)
        ...
        if (seg_left and seg_right):
            ...
            if (intersection_point):
                ...
                if (intersection_point > currEventPoint and 
                    ...
                    # print(f'[findNewEvent] Intersection point inserting')
