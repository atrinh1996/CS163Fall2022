...
%%%%%%%%%%%%%%%%%%
    ...
    \label{sec:topsweep}
        ...
        \begin{proof}
            ...
            an elementary step, i.e. it is ``ready''.
        \end{proof}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}[h]
        \center
        \includegraphics[width=0.6\textwidth]{htuhtloverlayed.png}
        \caption{The same topological cut in Fig. \ref{figure.linecut}, but with an overlay of the upper (purple) and lower (red) horizon tree, modified from Edelsbrunner, Guibas (1989). The cuts \texttt{c[i]} are ordered according to the article and is just important for how the authors explain the \textbf{I} data structure. \texttt{c[i]} doesn't necessarily belong to line $l_i$ in the figure.}
