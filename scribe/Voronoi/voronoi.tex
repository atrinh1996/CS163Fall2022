...
\def\doheading#1#2#3{\vfill\eject\vspace*{-\toppush}%
  \vbox
  {
      \hbox to\textwidth{{\bf} \subjnum: \subjname \hfil Professor
Diane Souvaine}%
  \hbox to\textwidth{{\bf} Tufts University, Spring 2022 \hfil Editor: Amy Bui \strut}
    % \hbox to\textwidth{{\bf} \hfil#3\strut}%
    \hbox to\textwidth{{\bf} \textbf{Voronoi Diagram} \hfil }
    \hrule
  }}
...
\begin{center}
\scalebox{0.65}{\includegraphics{fig1.png}}
\end{center}
...
\section{Definitions}
    ...
    $\overline{p_i p_j}$.
        ...
        \begin{center}
        \scalebox{0.75}{\includegraphics{fig2.png}}
        \end{center}
    ...
    H(p_i p_n) \]
        ...
        \begin{center}
        \scalebox{0.75}{\includegraphics{fig3.png}}
        \end{center}
...
\section{Properties of Voronoi Diagrams}
    ...
    circle is called the {\bf circumcircle} for triangle $\triangle abc$.
        ...
        \begin{center}
        \scalebox{0.75}{\includegraphics{fig4.png}}
        \end{center}
...
\section{Delaunay Triangulation}
    ...
    \begin{center}
    \framebox{\scalebox{0.6}{\includegraphics{fig8.png}}} \\
    \end{center}
...
\hrulefill}
    ...
    \framebox{\scalebox{0.6}{\includegraphics{fig-hull3.png}}} \\ {\em
    ...
    \framebox{\scalebox{0.6}{\includegraphics{fig-hull4.png}}} \\
...
\subsection{Sweep (Beach) Line (Fortune's Algorithm), $O(n\log n)$}
    ...
    \begin{center}
    \scalebox{0.75}{\includegraphics{fig5.png}}
    \end{center}
    ...
    \begin{center}
    \scalebox{0.75}{\includegraphics{fig6.png}}
    \end{center}
    ...
    \subsubsection{Complexity}
        ...
        % \begin{center}
        % \scalebox{0.75}{\includegraphics{figures/fig7.png}}
        % \end{center}
        % \pagebreak
...
is no such algorithm to be found.
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{thebibliography}{1}
      ...
      \bibitem[2]{voronoiinteract}Yunzhi Shi, \href{http://yunzhishi.github.io/voronoi.html}{``Sarah's Interactive Voronoi Diagram''}. 2017.
      \bibitem[3]{1990}Class notes, scribes: Valerie Barr, Hava Siegelmann, Gabor Sarkozy. 1990
      \bibitem[4]{2004}Class notes, scribes: Michael Horn, Julie Weber. 2004
    \end{thebibliography}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
